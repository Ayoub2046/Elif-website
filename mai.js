...
//  ... inside the DOMContentLoaded listener ...
    ...
    if (document.body.classList.contains('dashboard-page')) {
        ...
        sidebarLinks.forEach(link => {
            if (link.getAttribute('href') === '#') { // Target SPA links only
        ...
        // --- MOCK DATABASE ---
        let students = [ /* ... same data ... */ ];
        let teachers = [
            { id: 1, name: 'John Doe', subject: 'Mathematics', email: 'j.doe@school.edu', phone: '555-0201' },
            { id: 2, name: 'Jane Smith', subject: 'Physics', email: 'j.smith@school.edu', phone: '555-0202' },
        ];
        ...
        function renderStudentTable() { /* ... same code as before ... */ }
